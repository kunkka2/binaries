...
curl -L https://github.com/kunkka2/binaries/raw/refs/heads/main/others/zabbix/serverconnector.go -o zabbix-7.4.11/src/go/internal/agent/serverconnector/serverconnector.go
